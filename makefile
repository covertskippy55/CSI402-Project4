...
p4:   main.o  functions.o
	gcc main.o functions.o -o p4
...
main.o:   constants.h  prototypes.h struct_def.h

functions.o:  constants.h  prototypes.h struct_def.h

struct_def.h: constants.h
